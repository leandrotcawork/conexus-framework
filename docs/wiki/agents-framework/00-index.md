...
Studio UI: 21 (Wave 0 scaffold → Wave 1 agent/connector/REPL views → Phase A 4-layer capability tab → Phase C unified packs registry → Phase D pack install/uninstall → Phase E GitHub Wiki connect/disconnect).
