# src/conexus/tests/test_connector_inspector.py
import json
...
def test_list_returns_only_skills_referencing_connector_packs(tmp_path: Path):
    registry = tmp_path / "connectors" / "registry.json"
...
def test_list_empty_when_no_skills_match(tmp_path: Path):
    ...
    registry.write_text(json.dumps({"version": "1.0", "connectors": [
        {"name": "x", "version": "1.0", "server_url": "u", "scopes": [], "ui": {}}
    ]}))
